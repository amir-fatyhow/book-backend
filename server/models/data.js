...
async function insertDataGenres() {
    const roman = Genre.build({
        id: 1,
        name: "roman"
    })
    await roman.save()

    const fantasy = Genre.build({
        id: 2,
        name: "fantasy"
    })
    await fantasy.save()

    const thriller = Genre.build({
        id: 3,
        name: "thriller"
    })
    await thriller.save()

    const fairy_tail = Genre.build({
        id: 4,
        name: "fairy tail"
    })
    await fairy_tail.save()
}
insertDataGenres()

async function insertDataBooks() {
    // roman
